...
//   bot.hear(/hi/, res => {
//     return res.send("Hey! Welcome to the Sydney Opera House. Let me help you find what's happening today." + " https://www.instagram.com/p/BSkm30UBXFC/?taken-by=sydneyoperahouse")
//     // res.send("We have the classics - ballet, opera, orchestra. If you're more adventurous, we have talks, family shows, theatre, dance and contemporary music.")
// });
...
// ];
  ...
  //     return res.reply(musicShows)
  //
  //   } else if (genre === "classic", "classics", "classical", "classical music", "ballet", "opera", "dance", "contemporary dance") {
  //     return res.reply(classicShows)
  //
  //   } else if (genre === "talk", "talks", "ideas", "speaker", "speakers") {
  //     return res.reply(talksShows)
  //
  //   } else {
  //     return res.reply(`${genre}? I don't think we have ${genre} on today. Is there anything else you'd like to see? Maybe talks, or family shows? Orchestras?`)
  //   }
  // });
